...
import { Sparkles, Bot, MessageSquare, Video } from "lucide-react"; // 'X' eliminado de las importaciones
...
export default function PromptModal({ isOpen, onClose }: PromptModalProps) {
  const prompts = [
    ...
    {
      title: "GEMINI (Asistencia General)",
      icon: Sparkles,
      ...
      <DialogContent className="max-w-3xl max-h-[85vh] overflow-hidden bg-gradient-to-br from-white to-gray-50 border-0 shadow-2xl">
        <DialogHeader className="border-b border-gray-200 pb-6">
          <div className="flex justify-between items-center">
            ...
            {/* El botón de cierre 'X' ya es proporcionado por el componente DialogContent de shadcn/ui. */}
            {/* Se elimina el botón 'X' personalizado para evitar duplicados. */}
            {/* <button 
              onClick={onClose}
